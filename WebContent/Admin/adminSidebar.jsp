...
<%@ include file="/homeParts/HeaderAdmin.jsp" %>	
                        ...
                        <div class="sidebar__categories">
                            ...
                            <div class="categories__accordion">
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a href="<%= request.getContextPath() %>/allMesAsso"> Gerer Associations </a>
                                        </div>                                     
                                    </div>
                                                     <div class="card">
                                        <div class="card-heading">
                                           <a href="/AssociationMarket/beneficiaireAllAssociation"> Gerer Beneficiaires </a>
                                        </div>                                     
                                    </div>
                                   
                                    <div class="card">
                                        <div class="card-heading">
                                            <a href="/AssociationMarket/clientAll"> Gerer clients </a>
                                        </div>                                     
                                    </div>
                                     <div class="card">
                                        <div class="card-heading">
                                            <a href="/AssociationMarket/CategorieAll"> Gerer Categories </a>
                                        </div>                                     
                                    </div>
