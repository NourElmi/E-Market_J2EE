    ...
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3 style="text-align: center ">Login Beneficiaire <strong>:</strong></h3>
            <p class="mb-4"></p>
            <form action="/AssociationMarket/beneficiaire_Login" method="post">
        ...
        <!--       <div class="d-flex mb-5 align-items-center">
              ...
              <input type="submit" value="Log In" class="btn btn-block btn-primary" style=" background-color:#C91616; border-color:#C91616" > <br>
           <input type="button" onclick="window.location.href = '<%= request.getContextPath() %>/Beneficiaire/benefRegester.jsp';" value="Register" class="btn btn-block btn-primary" style=" background-color:#C91616; border-color:#C91616"/>
