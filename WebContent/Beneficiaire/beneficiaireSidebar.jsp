                    ...
                    <div class="shop__sidebar">
                        <div class="sidebar__categories">
                            <div class="section-title">
                                 ...
                                 <h4>Beneficiaire ${ sessionScope.nomBenefi } </h4>
                            </div>
                            <div class="categories__accordion">
                                <div class="accordion" id="accordionExample">
                                      <div class="card">
                                        <div class="card-heading">
                                            <a href="<%= request.getContextPath() %>/beneficiaireProfile"> Profile </a>
                                        </div>                                     
                                    </div>
                                 
                                    <div class="card">
                                        <div class="card-heading">
                                            <a href="<%= request.getContextPath() %>/beneficiaireProdAdonner"> Produit a donner </a>
                                        </div>                                     
                                    </div>
                                      <div class="card">
                                        <div class="card-heading">
                                          
                                            <a href="<%= request.getContextPath() %>/allProdemanderByBene"> produit demandé </a>
                                        </div>    
                                        
                                         <!-- /Association/beneficiaireAdd.jsp-->
