                ...
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="<%= request.getContextPath() %>/produitVenteAllByAsso" >MyMarket</a></li> 
                             <%-- <li><a href="#">Pages</a>
                                <ul class="dropdown">
                ...
                <div class="col-lg-3">
                    <div class="header__right">
                        <div class="header__right__auth">
							...
							<c:choose>
								  <c:when test="${not empty sessionScope.IdAdmin }">
								  		<a href="<%= request.getContextPath() %>/profileAdmin.jsp " > 
								  			<c:out value ="${ sessionScope.NomAdmin }"/>
								  		</a>
								  </c:when>
								  <c:otherwise>
