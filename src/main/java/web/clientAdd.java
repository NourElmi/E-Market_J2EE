...
//		//int idAsso_benef=1;
		...
		String nomBenefi =request.getParameter( "nomClient" ) ;
		String prenomBenefi =request.getParameter( "prenomClient" ) ;
		...
		clientInterf.addClient(nomBenefi, prenomBenefi, login,password,numTel,adresse,genre,dateNaissance);
		
		
		
		response.sendRedirect("/AssociationMarket/Client/clientLogin.jsp");
		//faut creer all
	}
}